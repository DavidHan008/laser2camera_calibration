...
#Attention:
The names of lidar data should be xxxxx1.ply,xxxxx2.ply ...;there should not be '0' such as xxxxx.01.ply etc.
And the intrinsic and extrinsic parameters need have high precision about 10 numbers after  Decimal point.
